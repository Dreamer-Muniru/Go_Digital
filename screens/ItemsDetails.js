    ...
    <SafeAreaView className="flex-1 bg-white relative">
        <ScrollView className="flex-1 px-4 py-6">
            <View className="relative bg-white shadow-lg">
                ...
                />
                <View className="absolute flex-row inset-x-8 top-5 justify-between px-6">
                ...
                <View className="absolute flex-row inset-x-8 bottom-5 justify-between px-6">
            ...
            <View className="mt-4 flex-row items-center justify-between">
                ...
                {data?.rating && (
                    <View className="flex-row items-center space-x-2">
                        <View className="w-8 h-8 rounded-2xl bg-red-100 items-center justify-center shadow-md">
                ...
                {/* PRICING VIEW */}
                    {data?.price_level && (
                        <View className="flex-row items-center space-x-2">
                            <View className="w8 h-8 rounded-2xl bg-red-100 items-center justify-center shadow-md">
            ...
            {/* Other Contact Details View */}
            <View className="space-y-2 mt-4 bg-gray-100 rounded-2xl px-4 py-2">
                {/* phone */}
                {/* {data?.phone && (
                    <View className="items-center flex-row space-x-6">
                        <FontAwesome name="phone" size={24} color="#428388" />
